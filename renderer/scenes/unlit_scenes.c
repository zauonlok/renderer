...
scene_t *unlit_mccree_scene(void) {
    ...
    unlit_material_t materials[28] = {
        {{0.614f, 0.396f, 0.464f, 1}, NULL, 1, 0},
        {{0.689f, 0.441f, 0.516f, 1}, NULL, 1, 0},
        {{0.736f, 0.471f, 0.552f, 1}, NULL, 1, 0},
        {{0.430f, 0.241f, 0.296f, 1}, NULL, 1, 0},
        {{0.347f, 0.855f, 1.000f, 1}, NULL, 1, 0},
        {{0.399f, 0.522f, 0.397f, 1}, NULL, 1, 0},
        {{0.850f, 0.160f, 0.086f, 1}, NULL, 1, 0},
        {{1.000f, 0.423f, 0.170f, 1}, NULL, 1, 0},
        {{0.193f, 0.374f, 0.333f, 1}, NULL, 1, 0},
        {{1.000f, 1.000f, 1.000f, 1}, NULL, 1, 0},
        {{0.317f, 0.158f, 0.229f, 1}, NULL, 1, 0},
        {{0.425f, 0.198f, 0.233f, 1}, NULL, 1, 0},
        {{0.779f, 0.310f, 0.263f, 1}, NULL, 1, 0},
        {{0.964f, 0.744f, 0.622f, 1}, NULL, 1, 0},
        {{0.641f, 0.252f, 0.234f, 1}, NULL, 1, 0},
        {{0.973f, 0.801f, 0.705f, 1}, NULL, 1, 0},
        {{0.938f, 0.814f, 0.687f, 1}, NULL, 1, 0},
        {{0.748f, 0.596f, 0.418f, 1}, NULL, 1, 0},
        {{0.831f, 0.618f, 0.525f, 1}, NULL, 1, 0},
        {{0.694f, 0.510f, 0.427f, 1}, NULL, 1, 0},
        {{0.336f, 0.149f, 0.205f, 1}, NULL, 1, 0},
        {{0.445f, 0.195f, 0.270f, 1}, NULL, 1, 0},
        {{0.444f, 0.187f, 0.207f, 1}, NULL, 1, 0},
        {{0.927f, 0.483f, 0.498f, 1}, NULL, 1, 0},
        {{0.815f, 0.403f, 0.418f, 1}, NULL, 1, 0},
        {{0.827f, 0.430f, 0.449f, 1}, NULL, 1, 0},
        {{0.542f, 0.222f, 0.247f, 1}, NULL, 1, 0},
        {{1.000f, 0.808f, 0.571f, 1}, NULL, 1, 0},
    };
...
scene_t *unlit_elfgirl_scene(void) {
    ...
    unlit_material_t materials[] = {
        {{1, 1, 1, 1}, "assets/elfgirl/base.tga", 0, 0},
        {{1, 1, 1, 1}, "assets/elfgirl/body.tga", 0, 0},
        {{1, 1, 1, 1}, "assets/elfgirl/body.tga", 0, 0},
        {{1, 1, 1, 1}, "assets/elfgirl/body.tga", 0, 0},
        {{1, 1, 1, 1}, "assets/elfgirl/face.tga", 0, 0},
        {{1, 1, 1, 1}, "assets/elfgirl/face.tga", 0, 0},
        {{1, 1, 1, 1}, "assets/elfgirl/hair.tga", 0, 0},
    };
