...
scene_t *unlit_mccree_scene(void) {
    ...
    unlit_material_t materials[28] = {
        {{0.614f, 0.396f, 0.464f}, NULL},
        {{0.689f, 0.441f, 0.516f}, NULL},
        {{0.736f, 0.471f, 0.552f}, NULL},
        {{0.430f, 0.241f, 0.296f}, NULL},
        {{0.347f, 0.855f, 1.000f}, NULL},
        {{0.399f, 0.522f, 0.397f}, NULL},
        {{0.850f, 0.160f, 0.086f}, NULL},
        {{1.000f, 0.423f, 0.170f}, NULL},
        {{0.193f, 0.374f, 0.333f}, NULL},
        {{1.000f, 1.000f, 1.000f}, NULL},
        {{0.317f, 0.158f, 0.229f}, NULL},
        {{0.425f, 0.198f, 0.233f}, NULL},
        {{0.779f, 0.310f, 0.263f}, NULL},
        {{0.964f, 0.744f, 0.622f}, NULL},
        {{0.641f, 0.252f, 0.234f}, NULL},
        {{0.973f, 0.801f, 0.705f}, NULL},
        {{0.938f, 0.814f, 0.687f}, NULL},
        {{0.748f, 0.596f, 0.418f}, NULL},
        {{0.831f, 0.618f, 0.525f}, NULL},
        {{0.694f, 0.510f, 0.427f}, NULL},
        {{0.336f, 0.149f, 0.205f}, NULL},
        {{0.445f, 0.195f, 0.270f}, NULL},
        {{0.444f, 0.187f, 0.207f}, NULL},
        {{0.927f, 0.483f, 0.498f}, NULL},
        {{0.815f, 0.403f, 0.418f}, NULL},
        {{0.827f, 0.430f, 0.449f}, NULL},
        {{0.542f, 0.222f, 0.247f}, NULL},
        {{1.000f, 0.808f, 0.571f}, NULL},
    };
...
scene_t *unlit_elfgirl_scene(void) {
    ...
    unlit_material_t materials[] = {
        {{1, 1, 1}, "assets/elfgirl/base.tga"},
        {{1, 1, 1}, "assets/elfgirl/body.tga"},
        {{1, 1, 1}, "assets/elfgirl/body.tga"},
        {{1, 1, 1}, "assets/elfgirl/body.tga"},
        {{1, 1, 1}, "assets/elfgirl/face.tga"},
        {{1, 1, 1}, "assets/elfgirl/face.tga"},
        {{1, 1, 1}, "assets/elfgirl/hair.tga"},
    };
